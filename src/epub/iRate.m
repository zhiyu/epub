...
- (iRate *)init
{
    if ((self = [super init]))
    {
        ...
        self.cancelButtonLabel = NSLocalizedString(@"cancelButtonLabel", nil);
        self.remindButtonLabel = NSLocalizedString(@"remindButtonLabel", nil);
        self.rateButtonLabel = NSLocalizedString(@"rateButtonLabel", nil);
    }
    return self;
}
...
- (NSString *)message
{
    ...
    return [NSString stringWithFormat:NSLocalizedString(@"rateText", nil), applicationName];
}
